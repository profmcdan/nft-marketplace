...
function PruneKryptoMarketplace({Component, pageProps}){
  return (
    <div>
      <nav className='border-b p-6' style={{ backgroundColor: 'purple' }}>
        <p className='text-4x1 font-bold text-white'>PruneKrypto Marketplace</p>
...
export default PruneKryptoMarketplace;
